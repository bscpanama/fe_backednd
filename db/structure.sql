...
--
-- Name: account_statuses; Type: TYPE; Schema: public; Owner: -
--

CREATE TYPE public.account_statuses AS ENUM (
    'activo',
    'inactivo'
);
...
CREATE TABLE public.accounts (
    ...
    status public.account_statuses DEFAULT 'activo'::public.account_statuses
);
